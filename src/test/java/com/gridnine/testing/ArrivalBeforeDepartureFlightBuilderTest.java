...
class ArrivalBeforeDepartureFlightBuilderTest {
    ...
    static List<Flight> createTestFlights() {
        return Arrays.asList(
                ...
                //A flight that segment arrives before it departing
                createTestFlight(TWO_DAYS_FROM_NOW, TWO_DAYS_FROM_NOW.plusHours(2),
                        TWO_DAYS_FROM_NOW.plusHours(5), TWO_DAYS_FROM_NOW.minusHours(6)),
    ...
    void filterFlights() {
        ...
        List<Flight> filteredFlights = new ArrivalBeforeDepartureFilter().filterFlights(flights);
        assertThat(filteredFlights, hasSize(4));
        assertThat(filteredFlights,
                not(hasItem(createTestFlight(TWO_DAYS_FROM_NOW, TWO_DAYS_FROM_NOW.minusHours(6)))));
        assertThat(filteredFlights,
